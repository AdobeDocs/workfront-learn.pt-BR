...
* **Filtros Personalizar relatórios de lista:** Os filtros no Workfront permitem que os usuários restringam listas (tarefas, projetos, documentos, etc.) com base em critérios específicos, mostrando apenas itens que correspondem às condições e que são acessíveis ao usuário conectado. &#x200B;
