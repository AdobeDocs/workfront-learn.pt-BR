...
Essa adição “empilha” as versões sobre o arquivo original, mantendo um histórico das revisões e garantindo a visualização da iteração mais recente do trabalho. O visualizador de revisões do Workfront também permite comparar a versão mais recente com uma anterior do arquivo.
