...
+ Administração e configuração {#administration-and-setup}
   + Configuração organizacional {#organizational-setup}
      ...
      + [Entender a necessidade de administração de grupos](administration-and-setup/organizational-setup/introduction-to-group-administrators.md)
   ...
   + Gerenciar itens excluídos {#manage-deleted-items}
      + [Restaure objetos da lixeira](administration-and-setup/manage-deleted-items/restore-objects-from-the-recycle-bin.md)
   + Configurar padrões do sistema {#configure-system-defaults}
      + [Definir configurações de projeto padrão global](administration-and-setup/configure-system-defaults/configure-global-default-project-settings.md)
      + [Entender os tipos de problemas padrão](administration-and-setup/configure-system-defaults/default-issue-types.md)
      + [Criar um status de ocorrência](administration-and-setup/configure-system-defaults/create-an-issue-status.md)
      ...
      + [Criar e gerenciar as severidades de problemas](administration-and-setup/configure-system-defaults/create-and-manage-issue-severities.md)
      ...
      + [Configurar preferências de problema padrão global](administration-and-setup/configure-system-defaults/configure-global-default-issue-preferences.md)
   + Modelos de layout {#layout-templates}
      ...
      + [Personalizar cabeçalhos de projeto com modelos de layout](administration-and-setup/layout-templates/customize-project-headers-with-layout-templates.md)
   ...
   + Notificações por email e no aplicativo {#email-and-in-app-notifications}
      + [Gerenciar notificações por email e no aplicativo](administration-and-setup/email-and-in-app-notifications/manage-inapp-and-email-notifications.md)
      + [Configurar notificações de evento](administration-and-setup/email-and-in-app-notifications/admin-set-up-event-notifications.md)
      + [Enviar [!UICONTROL Central de anúncios] messages](administration-and-setup/email-and-in-app-notifications/admin-use-the-announcement-center.md)
      ...
      + [Anexar notificações de lembrete aos itens de trabalho](administration-and-setup/email-and-in-app-notifications/user-attach-reminder-notifications.md)
      ...
      + [Inscrever-se em itens de trabalho](administration-and-setup/email-and-in-app-notifications/user-subscribe-to-work-items.md)
   + Criar e gerenciar usuários {#create-and-manage-users}
      ...
      + [Criar um usuário individual](administration-and-setup/create-and-manage-users/create-an-individual-user-profile.md)
      + [Adicionar usuários em massa](administration-and-setup/create-and-manage-users/add-users-in-bulk.md)
      ...
      + [Entender o log de auditoria do sistema](administration-and-setup/create-and-manage-users/system-audit-log.md)
   + Processos de aprovação e caminhos de marco {#approval-processes-and-milestone-paths}
      + [Entender os processos de aprovação específicos do grupo](administration-and-setup/approval-processes-and-milestone-paths/group-specific-approval-processes.md)
...
+ Dados personalizados {#custom-data}
   ...
   + Expressões calculadas {#calculated-expressions}
      + [Introdução a campos e expressões calculados](custom-data/calculated-expressions/get-started-with-calculated-fields-and-expressions.md)
      + [Saiba mais sobre a estrutura da expressão de dados](custom-data/calculated-expressions/data-expression-structure.md)
      + [Entender Data e Hora e Expressões Matemáticas](custom-data/calculated-expressions/date-and-time-and-mathematical-expressions.md)
      + [Crie expressões ADDDAYS, ADDWEEKDAY, ADDMONTHS, ADDYEARS](custom-data/calculated-expressions/create-adddays-addweekdays-addmonths-addyears-expressions.md)
      + [Usar o Editor de Cálculo](custom-data/calculated-expressions/use-the-calculation-editor.md)
      ...
      + [Use a expressão CONCAT em um campo calculado](custom-data/calculated-expressions/use-the-concat-expression-in-a-calculated-field.md)
...
+ Gerenciar trabalho {#manage-work}
   + Projetos {#projects}
      ...
      + [Saiba mais sobre quatro maneiras de criar um projeto](manage-work/projects/understand-other-ways-to-create-projects.md)
      ...
      + [Fechar o projeto](manage-work/projects/change-the-project-status.md)
   + Tarefas {#tasks}
   ...
   + Portfólios {#portfolios}
      ...
      + [Introdução ao Caso de negócios](portfolios-and-programs/introduction-to-the-business-case.md)
      + [Priorizar e gerenciar o trabalho com portfólios](portfolios-and-programs/prioritize-and-manage-work-with-portfolios.md)
   + Solicitar filas {#request-queues}
      + [Entender as filas de solicitação](manage-work/request-queues/understand-request-queues.md)
      + [Entender as configurações de uma solicitação de fluxo](manage-work/request-queues/understand-settings-for-a-flow-request.md)
      + [Criar uma fila de solicitações](manage-work/request-queues/create-a-request-queue.md)
      + [Criar um fluxo de solicitação](manage-work/request-queues/create-a-request-flow.md)
      + [Respostas a perguntas comuns sobre filas de solicitação](manage-work/request-queues/request-queue-faq.md)
   + Processos de aprovação e caminhos de marco {#approval-processes-and-milestone-paths}
      ...
      + [Delegar tarefas, emissões e aprovações](manage-work/approval-processes-and-milestone-paths/delegate-approvals.md)
      + [Visualizar marcos](manage-work/approval-processes-and-milestone-paths/view-milestones.md)
   ...
   + Linhas do tempo do projeto {#project-timelines}
      ...
      + [Rastrear o progresso a partir da linha do tempo do projeto](manage-work/project-timelines/track-work-progress-from-the-project-timeline.md)
...
+ Relatórios {#reporting}
   + Relatórios básicos {#basic-reporting}
      + [Entender os elementos de relatório](reporting/basic-reporting/reporting-elements.md)
      + [Entender os componentes de relatório](reporting/basic-reporting/reporting-components.md)
      + [Criar um agrupamento básico](reporting/basic-reporting/create-a-basic-grouping.md)
      + [Criar uma exibição básica](reporting/basic-reporting/create-a-basic-view.md)
      + [Adicionar formatação condicional básica](reporting/basic-reporting/add-basic-conditional-formatting-to-a-view.md)
      + [Criar um filtro básico](reporting/basic-reporting/create-a-basic-filter.md)
      + [Criar uma atividade de filtro básica](reporting/basic-reporting/create-a-basic-filter-activity.md)
      + [Criar um relatório simples](reporting/basic-reporting/create-a-simple-report.md)
      + [Criar um relatório de tarefa](reporting/basic-reporting/create-a-task-report.md)
      + [Criar relatórios com gráficos](reporting/basic-reporting/create-reports-with-charts.md)
      + [Criar um relatório de matriz](reporting/basic-reporting/create-a-matrix-report.md)
      + [Criar painéis](reporting/basic-reporting/create-dashboards.md)
      + [Enviar e compartilhar relatórios](reporting/basic-reporting/how-to-send-and-share-reports.md)
      + [Entender as configurações do relatório](reporting/basic-reporting/report-settings.md)
      + [Entender a interface do calendário](reporting/basic-reporting/tour-of-the-interface.md)
      + [Criar um calendário personalizado](reporting/basic-reporting/creating-custom-calendars.md)
      + [Entender as opções adicionais de calendário](reporting/basic-reporting/additional-calendar-options.md)
      + [Sua vez de criar um calendário](reporting/basic-reporting/your-turn-to-create-a-calendar.md)
   + Relatórios intermediários {#intermediate-reporting}
      + [Criar filtros com curingas baseadas em usuário](reporting/intermediate-reporting/create-filters-with-user-based-wildcards.md)
      + [Criar filtros com caracteres curingas com base em data](reporting/intermediate-reporting/create-filters-with-date-based-wildcards.md)
      + [Criar instruções OR em filtros](reporting/intermediate-reporting/or-statements-in-filters.md)
      + [Entender os filtros de projeto incorporados](reporting/intermediate-reporting/open-built-in-project-filters.md)
   ...
   + Analítica aprimorada {#enhanced-analytics}
      ...
      + [Entender gráficos de trabalho e de pessoas](reporting/enhanced-analytics/5-work-and-people-charts.md)
      + [Entender filtros](reporting/enhanced-analytics/6-filters-overview.md)
      + [Entender intervalos de datas e intervalos de tempo](reporting/enhanced-analytics/7-date-ranges-vs-timeframes.md)
      + [Entender as horas planejadas e as exibições de duração](reporting/enhanced-analytics/8-planned-hours-and-duration-views.md)
      + [Entender ações: clique com o mouse e arraste e clique em](reporting/enhanced-analytics/9-actions-hover-click-and-drag-and-click-in.md)
      + [Entender KPIs](reporting/enhanced-analytics/10-kpis-overview.md)
      + [Entender navegação e revisão de projetos](reporting/enhanced-analytics/11-navigating-and-reviewing-projects.md)
      + [Aprofunde-se usando cronogramas e gráficos adicionais](reporting/enhanced-analytics/12-digging-deeper-using-timeframes-and-additional-charts.md)
      + [Entender navegação e revisar atividade do projeto](reporting/enhanced-analytics/13-navigating-and-reviewing-project-activity.md)
      + [Aprofunde-se na navegação](reporting/enhanced-analytics/14-navigation-and-digging-deeper.md)
      + [Compreender como acessar e revisar o detalhamento](reporting/enhanced-analytics/15-accessing-and-reviewing-the-burndown.md)
      + [Revisar as tarefas em andamento](reporting/enhanced-analytics/16-navigating-to-and-reviewing-the-tasks-in-flight.md)
      + [Execute ações fazendo atualizações](reporting/enhanced-analytics/17-taking-action-by-making-updates.md)
      + [Entender o gráfico de atividade por equipe](reporting/enhanced-analytics/18-activity-by-team-chart.md)
      + [Entender o gráfico de capacidade de recursos](reporting/enhanced-analytics/19-resource-capacity-chart.md)
      + [Entender a capacidade da equipe](reporting/enhanced-analytics/20-team-capacity-overview.md)
      + [Entender um caso de uso de comparações de KPI](reporting/enhanced-analytics/21-kpi-comparisons.md)
      + [Entender um caso de uso do usuário final](reporting/enhanced-analytics/22-end-user-use.md)
      + [Entender orientação de consultoria](reporting/enhanced-analytics/23-consulting-guidance.md)
...
+ Gerenciar recursos {#manage-resources}
   + Gerenciamento de recursos {#resource-management}
      + [Prazo de gestão dos recursos](manage-resources/resource-management/resource-management-maturity.md)
      ...
      + [Configurações de gerenciamento de recursos, Balanceador de carga de trabalho e Relatório de utilização](manage-resources/resource-management/rm-setups-workload-balancer-and-utilization-report.md)
   + Balanceador de carga de trabalho {#workload-balancer}
      + [Localizar o Balanceador de Carga de Trabalho](manage-resources/workload-balancer/find-the-workload-balancer.md)
      ...
      + [Configurações a serem consideradas para o Balanceador de Carga de Trabalho](manage-resources/workload-balancer/settings-to-consider-for-the-workload-balancer.md)
      + [Atribuir trabalho no Balanceador de Carga de Trabalho](manage-resources/workload-balancer/assign-work-in-the-workload-balancer.md)
   + Planejamento de recursos {#resource-planning}
      ...
      + [Visualizar utilização](manage-resources/resource-planning/view-utlization-intro-filter-the-resource-planner.md)
   ...
   + Calendário de Hora Pessoal {#personal-time-off-calendar}
      + [Por que usar a hora do calendário?](manage-resources/pto/why-use-time-off-calendar.md)
      + [Como o tempo limite afeta as linhas do tempo do projeto](manage-resources/pto/how-time-off-affects-project-timelines.md)
      + [Gerenciar o tempo limite de outros usuários](manage-resources/pto/manage-other-users-time-off.md)
   ...
   + Planejador de cenários {#scenario-planner}
      ...
      + [Ajustar informações de função, orçamento e custo no Planejador de Cenário](manage-resources/scenario-planner/adjust-job-role-budget-and-cost-information-in-the-scenario-planner.md)
...
+ Workfront Goals {#workfront-goals}
   + Estabeleça uma visão para a sua organização {#establish-a-vision-and-strategy}
      + [Entender a visão por trás das metas do Workfront](workfront-goals/establish-a-vision-for-your-org/understand-the-vision-behind-workfront-goals.md)
      + [Entenda como as metas do Workfront funcionam](workfront-goals/establish-a-vision-for-your-org/understand-how-workfront-goals-works.md)
      + [Entenda como as Metas do Workfront se encaixam no seu ciclo de trabalho](workfront-goals/establish-a-vision-for-your-org/where-does-workfront-goals-fit-in-with-my-work-cycle.md)
      + [Estabeleça uma visão e estratégia para sua organização](workfront-goals/establish-a-vision-for-your-org/establish-a-vision-and-strategy.md)
      + [Criar uma declaração clara de objetivo](workfront-goals/establish-a-vision-for-your-org/create-a-clear-objective-statement.md)
   ...
   + Gerenciar suas metas {#manage-goals}
      ...
      + [Atualizar o progresso em resultados e atividades](workfront-goals/manage-your-goals/make-a-quantitative-update.md)
...
+ Integrações {#integrations}
   + Adobe Creative Cloud {#adobe-creative-cloud}
      + [Usar plug-ins do Adobe Workfront para o Creative Cloud](integrations/adobe-creative-cloud/use-adobe-workfront-extensions-for-creative-cloud.md)
   ...
   + Jira {#jira}
      + [Crie visibilidade com o [!DNL Jira] Integração](integrations/jira/jira.md)
   + Microsoft Outlook {#outlook}
      + [Instalar o complemento Microsoft Outlook](integrations/outlook/integrations-microsoft-outlook.md)
   + Microsoft Teams {#ms-teams}
      + [Visão geral do Adobe Workfront for Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/workfront-for-microsoft-teams.html)
      + [Instalar o Adobe Workfront para Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/install-workfront-ms-teams.html)
      + [Acessar o Adobe Workfront do Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/access-workfront-from-ms-teams.html)
      + [Procure e compartilhe itens do Adobe Workfront no Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/search-for-and-share-wf-items-in-ms-teams.html)
      + [Criar tarefas do Adobe Workfront a partir do Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/create-workfront-tasks-from-ms-teams.html)
      + [Enviar solicitações do Adobe Workfront do Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/submit-workfront-requests-from-ms-teams.html)
      + [Gerenciar notificações do Adobe Workfront no Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/manage-wf-notifications-approval-requests-ms-teams.html)
   + Slack {#slack}
      ...
      + [Acesse sua lista de itens a fazer por meio de [!UICONTROL Slack]](integrations/slack/access-your-to-do-list-through-slack.md)
      + [Atribuir tarefas por meio de [!UICONTROL Slack]](integrations/slack/assign-tasks-through-slack.md)
      + [Faça aprovações por meio de [!UICONTROL Slack]](integrations/slack/make-approvals-through-slack.md)
...
+ Fusão {#fusion}
   + Bem-vindo ao Workfront Fusion {#welcome-to-workfront-fusion}
      ...
      + [Fazer logon como um novo usuário](fusion/1-welcome-to-workfront-fusion/log-in-as-a-new-user.md)
      + [Introdução e estratégia tecnológica](fusion/1-welcome-to-workfront-fusion/introduction-and-tech-strategy.md)
   ...
   + Noções básicas {#understand-the-basics}
      ...
      + [Painel de mapeamento e editor de fórmula](fusion/2-understand-the-basics/mapping-panel-and-formula-editor.md)
      + [Observações importantes do painel Mapeamento](fusion/2-understand-the-basics/mapping-panel-important-notes.md)
      + [Além da apresentação básica de mapeamento](fusion/2-understand-the-basics/beyond-basic-mapping-walkthrough.md)
      + [Usar filtros](fusion/2-understand-the-basics/use-filters.md)
      + [Apresentação de filtros](fusion/2-understand-the-basics/filters-walkthrough.md)
      + [Passo-a-passo para acessar versões anteriores](fusion/2-understand-the-basics/access-previous-versions-walkthrough.md)
   + Conectores e roteamento universais {#universal-connectors-and-routing}
      + [Visão geral de exercício dos conectores universais](fusion/3-universal-connectors-and-routing/universal-connectors-exercise-overview.md)
      + [Introdução aos conectores universais](fusion/3-universal-connectors-and-routing/introduction-to-universal-connectors-walkthrough.md)
      + [Entender roteadores](fusion/3-universal-connectors-and-routing/understand-routers.md)
      + [Apresentação de roteadores](fusion/3-universal-connectors-and-routing/routers-walkthrough.md)
      + [Padrões comuns de roteamento](fusion/3-universal-connectors-and-routing/common-routing-patterns.md)
      + [Apresentação dos padrões de roteamento](fusion/3-universal-connectors-and-routing/routing-patterns-walkthrough.md)
      + [Set-it e get-it](fusion/3-universal-connectors-and-routing/set-it-and-get-it.md)
      + [Apresentação de variáveis Get/set](fusion/3-universal-connectors-and-routing/get-set-variables-walkthrough.md)
   + Iteração e agregação {#iteration-and-aggregation}
      ...
      + [Introdução aos iteradores](fusion/4-iteration-and-aggregation/introduction-to-iterators-walkthrough.md)
      ...
      + [Apresentação de agregação avançada](fusion/4-iteration-and-aggregation/advanced-aggregation-walkthrough.md)
   + Histórico de execução e agendamento {#execution-history-and-scheduling}
      ...
      + [Entender o agendamento de cenário](fusion/5-execution-history-and-scheduling/understand-scenario-scheduling.md)
      + [Balanceamento de ciclos e pacotes](fusion/5-execution-history-and-scheduling/balance-runs-cycles-and-bundles.md)
      + [Executa ciclos e pacotes](fusion/5-execution-history-and-scheduling/runs-cycles-and-bundles-walkthrough.md)
   + Além dos módulos básicos {#beyond-basic-modules}
      + [Familiarize-se com aplicativos e módulos comuns adicionais](fusion/6-beyond-basic-modules/become-familiar-with-additional-apps-and-common-modules.md)
      + [Troque para cima](fusion/6-beyond-basic-modules/switch-it-up.md)
      + [Apresentação da função de comutador](fusion/6-beyond-basic-modules/switch-function-walkthrough.md)
      + [Apresentação do módulo de switch](fusion/6-beyond-basic-modules/switch-module-walkthrough.md)
      + [Entender o mundo do webhook](fusion/6-beyond-basic-modules/understand-the-webhook-world.md)
      + [Apresentação dos Webhooks](fusion/6-beyond-basic-modules/webhooks-walkthrough.md)
   + Estruturas de dados e armazenamentos de dados {#data-structures-and-data-stores}
      + [Entender as estruturas de dados](fusion/7-data-structures-and-data-stores/understand-data-structures.md)
      + [Apresentação das estruturas de dados](fusion/7-data-structures-and-data-stores/data-structures-walkthrough.md)
      + [Entender armazenamentos de dados](fusion/7-data-structures-and-data-stores/understand-data-stores.md)
      + [Apresentação dos armazenamentos de dados](fusion/7-data-structures-and-data-stores/data-stores-walkthrough.md)
   + Bbits e bobs funcionais finais {#final-functional-bits-and-bobs}
      + [Apresentação do aplicativo Workfront](fusion/8-final-functional-bits-and-bobs/workfront-app-walkthrough.md)
      + [Entender coleções e elementos de arrays](fusion/8-final-functional-bits-and-bobs/understand-arrays-collections-and-elements.md)
      + [Apresentação de Arrays](fusion/8-final-functional-bits-and-bobs/arrays-walkthrough.md)
      + [Entender o JSON em cenários](fusion/8-final-functional-bits-and-bobs/understand-json-in-scenarios.md)
      + [Trabalhando com a apresentação JSON](fusion/8-final-functional-bits-and-bobs/working-with-json-walkthrough.md)
   + Solução de problemas e tratamento de erros {#troubleshooting-and-error-handling}
      + [Solução de problemas avançada com a ferramenta dev](fusion/9-troubleshooting-and-error-handling/advanced-troubleshooting-with-the-dev-tool.md)
      + [Apresentação da ferramenta de desenvolvimento](fusion/9-troubleshooting-and-error-handling/dev-tool-walkthrough.md)
      + [O que é tratamento de erros](fusion/9-troubleshooting-and-error-handling/what-is-error-handling.md)
      + [Entender diretivas de tratamento de erros](fusion/9-troubleshooting-and-error-handling/understand-error-handling-directives.md)
      + [Erro ao manipular o passo a passo](fusion/9-troubleshooting-and-error-handling/error-handling-walkthrough.md)
      + [Entender execuções incompletas](fusion/9-troubleshooting-and-error-handling/understand-incomplete-executions.md)
      + [Apresentação de execuções incompletas](fusion/9-troubleshooting-and-error-handling/incomplete-executions-walkthrough.md)
   + Administração do Workfront Fusion {#workfront-fusion-administration}
      + [Entender equipes e usuários de organizações](fusion/10-workfront-fusion-administration/understand-organizations-teams-and-users.md)
      + [Apresentação da administração](fusion/10-workfront-fusion-administration/administration-walkthrough.md)
   + Otimização e teste do design {#design-optimization-and-testing}
      ...
      + [Teste e inicialização](fusion/11-design-optimization-and-testing/testing-considerations.md)
   + Exercícios {#exercises}
      + [Design do cenário inicial](fusion/12-exercises/initial-scenario-design.md)
      + [Além do mapeamento básico](fusion/12-exercises/beyond-basic-mapping.md)
      + [Filtros](fusion/12-exercises/filters.md)
      + [Acessar versões anteriores](fusion/12-exercises/access-previous-versions.md)
      ...
      + [Explorar execuções, ciclos e pacotes](fusion/12-exercises/exploring-runs-cycles-and-bundles.md)
      + [Função de comutação](fusion/12-exercises/switch-function.md)
      + [Módulo de switch](fusion/12-exercises/switch-module.md)
      + [Webhooks](fusion/12-exercises/webhooks.md)
      + [Estruturas de dados](fusion/12-exercises/data-structures.md)
      + [Repositórios de dados](fusion/12-exercises/data-stores.md)
      + [Trabalhar com JSON](fusion/12-exercises/working-with-json.md)
      + [Ferramenta Dev](fusion/12-exercises/devtool.md)
...
+ Prova do Workfront {#workfront-proof}
   + [Saiba mais sobre os benefícios da prova](workfront-proof/benefits-of-proofing-in-workfront.md)
   + [Entender a diferença entre um documento e uma prova](workfront-proof/document-vs-proof.md)
   + [Explicação dos visualizadores de prova](workfront-proof/two-options-for-the-proofing-viewers.md)
   ...
   + Administração e configuração {#administration-and-setup-for-proof}
      ...
      + [Configurar configurações padrão da conta de prova](workfront-proof/administration-and-setup/set-up-default-proof-account-settings.md)
      + [Configurações para usuários de prova](workfront-proof/administration-and-setup/settings-for-proof-users.md)
      + [Configurar configurações de prova global](workfront-proof/administration-and-setup/setup-global-proof-settings.md)
   + Fazer upload de provas {#upload-proofs}
      ...
      + [Converter um documento em uma prova](workfront-proof/upload-proofs/convert-a-document-to-a-proof.md)
      + [Exibir e comparar versões de prova](workfront-proof/upload-proofs/view-and-compare-proof-versions.md)
      ...
      + [Fazer upload de uma prova de um site](workfront-proof/upload-proofs/upload-a-proof-of-a-website.md)
      ...
      + [Fazer upload de uma prova com um fluxo de trabalho automatizado](workfront-proof/upload-proofs/upload-a-proof-with-an-automated-workflow.md)
      + [Fazer upload com um arrastar e soltar](workfront-proof/upload-proofs/upload-with-a-drag-and-drop.md)
      + [Combinar vários arquivos em uma única prova](workfront-proof/upload-proofs/combine-multiple-files-into-a-single-proof.md)
   + Fluxos de trabalho de prova {#proof-workflows}
      + [Entender workflows de prova como parte das linhas do tempo do projeto](workfront-proof/proof-workflows/understand-and-create-proof-workflows.md)
      + [Editar um workflow de prova](workfront-proof/proof-workflows/edit-a-proof-workflow.md)
      + [Criar grupos de modelo para organizar modelos de fluxo de trabalho automatizados](workfront-proof/administration-and-setup/create-template-groups.md)
   ...
   + Revisar e aprovar o trabalho {#review-and-approve-work-for-proof}
      ...
      + [Revisar e responder comentários de prova](workfront-proof/review-and-approve-work/review-and-respond-to-proof-comments.md)
      + [Revisar um vídeo com prova](workfront-proof/review-and-approve-work/review-a-video-with-proof.md)
      + [Revisar um site com prova](workfront-proof/review-and-approve-work/review-a-website-with-proof.md)
      + [Entender detalhes de prova](workfront-proof/review-and-approve-work/proof-details-overview.md)
      + [Gerenciar comentários de prova](workfront-proof/review-and-approve-work/manage-proof-comments.md)
      + [Rastrear progresso de prova](workfront-proof/review-and-approve-work/track-proof-progress.md)
...
+ Workfront DAM {#workfront-dam-program}
   + Configuração do sistema {#system-setup}
      + [Entender [!DNL Workfront DAM]](workfront-dam/system-setup/introduction-to-workfront-dam.md)
      + [Entender as configurações do sistema](workfront-dam/system-setup/system-setup-system-settings.md)
      + [Entender [!UICONTROL Brand Portal]](workfront-dam/system-setup/brand-connect-brand-portal-introduction.md)
      + [Analise e planeje uma [!DNL Workfront DAM] estratégia](workfront-dam/system-setup/analyze-and-plan-to-develop-a-workfront-dam-strategy.md)
   ...
   + Metadados e palavras-chave {#metadata-and-keywords}
      + [Entender metadados](workfront-dam/metadata-and-keywords/metadata-introduction.md)
      + [Ativar e aplicar a taxonomia de palavras-chave](workfront-dam/metadata-and-keywords/enable-and-enforce-keyword-taxonomy.md)
      ...
      + [Configurar mapeamento de metadados](workfront-dam/metadata-and-keywords/metadata-mapping.md)
      + [Configurar as palavras-chave dos metadados](workfront-dam/metadata-and-keywords/keyword-setup.md)
   ...
   + Personalização do Brand Connect {#brand-connect-customization}
      + [O que é [!UICONTROL Conexão de marca]?](workfront-dam/brand-connect-customization/what-is-brand-connect.md)
      + [Estabeleça as configurações do sistema em [!UICONTROL Conexão de marca]](workfront-dam/brand-connect-customization/establish-system-settings.md)
      + [Adicionar páginas personalizadas em [!UICONTROL Conexão de marca]](workfront-dam/brand-connect-customization/add-custom-pages-in-brand-connect.md)
      + [Crie diretrizes de marca em [!UICONTROL Conexão de marca]](workfront-dam/brand-connect-customization/create-brand-guidelines-in-brand-connect.md)
      + [Personalize a aparência de [!UICONTROL Conexão de marca]](workfront-dam/brand-connect-customization/customize-the-appearance-of-brand-connect.md)
      + [Personalize a aparência da [!UICONTROL Conexão de marca]](workfront-dam/brand-connect-customization/customize-the-look-of-brand-connect.md)
   + Usuário do Workfront DAM: Colaborador {#workfront-dam-contributor}
      + [Entender [!UICONTROL Workfront DAM] como um colaborador](workfront-dam/workfront-dam-user-contributor/contributor-getting-started.md)
      + [Entender o gerenciamento de ativos como um colaborador](workfront-dam/workfront-dam-user-contributor/contributor-asset-management.md)
      + [Entender encontrar ativos como um colaborador](workfront-dam/workfront-dam-user-contributor/contributor-find-assets.md)
      + [Entender as lightboxes como colaborador](workfront-dam/workfront-dam-user-contributor/contributor-lightboxes.md)
      + [Entender metadados e práticas recomendadas de palavra-chave como colaborador](workfront-dam/workfront-dam-user-contributor/metadata-and-keyword-best-practices.md)
      + [Trabalhar com ativos como um colaborador](workfront-dam/workfront-dam-user-contributor/contributor-work-with-assets.md)
      ...
      + [Publicar ativos como um colaborador](workfront-dam/workfront-dam-user-contributor/contributor-publish-assets.md)
      + [Adicione um [!UICONTROL Workfront DAM] link](workfront-dam/workfront-dam-user-contributor/add-a-workfront-dam-link-in-workfront.md)
   + Usuário do Brand Connect {#brand-connect}
      + [Entender [!UICONTROL Conexão de marca] como um usuário](workfront-dam/brand-connect-user/brand-connect-introduction.md)
      + [Entender [!UICONTROL Conexão de marca] notificações](workfront-dam/brand-connect-user/brand-connect-notifications.md)
      + [Entender o download e o compartilhamento como usuário](workfront-dam/brand-connect-user/brand-connect-downloading-and-sharing.md)
      + [Entender as lightboxes como usuário](workfront-dam/brand-connect-user/brand-connect-lightboxes.md)
      + [Entender navegação e pesquisar como usuário](workfront-dam/brand-connect-user/brand-connect-getting-started.md)
      + [Trabalhar com ativos como um usuário](workfront-dam/brand-connect-user/brand-connect-working-with-assets.md)
...
+ Página inicial {#home}
   ...
   + [Organizar a lista de itens a fazer](workfront-home/organize-your-to-do-list-in-workfront-home.md)
   + [Priorize seu trabalho](workfront-home/prioritize-your-work-in-workfront-home.md)
   ...
   + [Registrar horas de trabalho](workfront-home/log-hours-on-work-in-workfront-home.md)
   + [Marcar trabalho atribuído como concluído](workfront-home/mark-assigned-work-as-complete.md)
   ...
   + [Analisar o trabalho no [!UICONTROL Minhas atualizações] ou [!UICONTROL Início]](workfront-home/review-work-in-my-updates-or-workfront-home.md)
   + [Entender atualizações e notificações](manage-work/issues-requests/understand-updates-and-notifications.md)

+ Agile {#agile}

   + Scrum {#scrum}
      + [Crie uma equipe ágil de Sombra](agile/create-a-scrum-agile-team.md)
      + [Gerenciar o trabalho como uma equipe de Scrum](agile/manage-work-scrum-team.md)
      + [Ampliação do backlog](agile/gooming-the-backlog.md)
      + [Planejar e criar uma iteração](agile/plan-and-create-an-iteration.md)
      + [Uso da página de iteração](agile/using-the-iteration-page.md)
   + Kanban {#kanban}
      + [Criar uma equipe kanban](agile/create-a-kanban-team.md)
      + [Gerenciar o trabalho como uma equipe kanban](agile/manage-work-kanban-team.md)
   + Quadros  {#boards}
...
+ Práticas recomendadas {#best-practices}
   ...
   + [Unidades da organização](best-practices/organizational-units-bp.md)
   + [Portfolio e programas](best-practices/portfolios-programs-bp.md)
   + [Visualizar sandbox](best-practices/preview-sandbox-bp.md)
   + [Preferências de projeto, tarefa e emissão](best-practices/project-task-issue-preferences-bp.md)
   + [Modelos de projeto](best-practices/project-templates-bp.md)
   + [Prova do Workfront](best-practices/proofing-bp.md)
   + [Solicitar fila](best-practices/request-queues-bp.md)
   ...
   + [Relatório do modo de texto](best-practices/test-mode-reporting-bp.md)
   + [Planejamento e gerenciamento do cronograma](best-practices/timeline-planning-management-bp.md)
   + [Folhas de horas e tempo de logon](best-practices/timesheets-logging-time-bp.md)
...
+ [Benefícios do uso do ágil](agile/benefits-of-using-agile.md)
+ [O que é a metodologia Scrum e como ela funciona?](agile/what-is-the-scrum-methodology.md)
+ [Qual é a metodologia kanban e como ela funciona?](agile/what-is-the-kanban-methodology.md)
+ [Transição para Ágil](agile/transitioning-to-agile.md)
