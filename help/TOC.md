...
+ Relatórios {#reporting}
   ...
   + Analítica aprimorada {#enhanced-analytics}
      ...
      + [Adicionar a [!UICONTROL análise] nos modelos de layout](reporting/enhanced-analytics/3-adding-analytics-to-layout-templates.md)
...
+ Fusion {#fusion}
   ...
   + Exercícios {#exercises}
      ...
      + [Definir e obter variáveis](fusion/12-exercises/set-get-variables.md)
      ...
      + [Função Alternar](fusion/12-exercises/switch-function.md)
      + [Alternar módulo](fusion/12-exercises/switch-module.md)
      ...
      + [Ferramenta para desenvolvedores](fusion/12-exercises/devtool.md)
...
+ Prova do Workfront {#workfront-proof}
   ...
   + Administração e configuração {#administration-and-setup-for-proof}
      ...
      + [Definir configurações globais de revisão](workfront-proof/administration-and-setup/setup-global-proof-settings.md)
...
+ Workfront DAM {#workfront-dam-program}
   ...
   + Usuário do DAM do Workfront: colaborador {#workfront-dam-contributor}
      ...
      + [Entenda as práticas recomendadas de metadados e palavras-chave como colaborador](workfront-dam/workfront-dam-user-contributor/metadata-and-keyword-best-practices.md)
