...
+ Gerenciar trabalho {#manage-work}
   ...
   + Projetos intermediários {#intermediate-projects}
      ...
      + [Predecessoras avançadas](manage-work/intermediate-projects/advanced-predecessors.md)
...
+ Relatórios {#reporting}
   + Relatórios básicos {#basic-reporting}
      ...
      + [Adicionar formatação condicional básica a uma exibição](reporting/basic-reporting/add-basic-conditional-formatting-to-a-view.md)
   ...
   + Relatórios de calendário {#calendar-reports}
      + [Entender a interface de relatório do calendário](reporting/basic-reporting/tour-of-the-interface.md)
      + [Criar um relatório de calendário personalizado](reporting/basic-reporting/creating-custom-calendars.md)
      + [Entender as opções adicionais de relatório de calendário](reporting/basic-reporting/additional-calendar-options.md)
...
+ Integrações {#integrations}
   ...
   + Adobe Experience Manager Assets Essentials {#adobe-assets-essentials}
      + [Configuração da integração](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/configure.html)
      ...
      + [Manter histórico de versão](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/versions.html)
...
+ Fusão {#fusion}
   ...
   + Conectores e roteamento universais {#universal-connectors-and-routing}
      ...
      + [Apresentação das variáveis Get/Set](fusion/3-universal-connectors-and-routing/get-set-variables-walkthrough.md)
   ...
   + Exercícios {#exercises}
      ...
      + [Explorar ciclos de execução e pacotes](fusion/12-exercises/exploring-runs-cycles-and-bundles.md)
