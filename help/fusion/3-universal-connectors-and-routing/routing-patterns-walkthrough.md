...
description: Saiba como usar o módulo Definir Variável para enviar um número por vários caminhos para ver como os filtros e fallbacks se comportam em [!DNL Adobe Workfront Fusion].
activity: use
