...
description: Saiba mais sobre o valor de armazenar execuções incompletas e, em seguida, executar novamente os pacotes após avaliar e corrigir erros em [!DNL Adobe Workfront Fusion].
activity: use
