...
description: Saiba como usar um webhook para criar um aplicativo para determinar se um cliente tem idade suficiente para comprar álcool, tudo no [!DNL Adobe Workfront Fusion].
activity: use
